...
// Prepare data for the chart based on stays
function prepareData(startData, stays) {
  // Increment the value of the corresponding duration in the array
  ...
  const data = stays
    ...
    .filter((obj) => obj.value > 0); // Filter out entries with no value
...
function DurationChart({ confirmedStays }) {
  ...
  const startData = isDarkMode ? startDataDark : startDataLight; // Choose start data based on theme
  const data = prepareData(startData, confirmedStays); // Prepare data for the chart
